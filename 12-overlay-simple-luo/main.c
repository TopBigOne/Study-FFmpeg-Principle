...
int main() {
    ...
    const char *logo_path = "/Users/dev/Documents/Android_work/main_ffmpeg/FFmpeg-Principle/12-overlay-simple-luo/logo.jpeg";
    AVFrame    *logo_frame   = get_frame_from_jpeg_or_png_file(logo_path, &logo_tb, &logo_fr);
    if (NULL == logo_frame) {
