...
#define FFMPEG_CONFIGURATION "--prefix=/usr/local/ffmpeg/4.4"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2023
#define FFMPEG_DATADIR "/usr/local/ffmpeg/4.4/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/ffmpeg/4.4/share/ffmpeg"
